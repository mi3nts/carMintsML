...
function [] = palasDataImport(yamlFile)
    ...
    palasFromRaw            = referenceFolder   + "/palas"; 
    ...
    palasDataNow.Properties.VariableNames= {'pm1_palas',...
                                            'pm2_5_palas',...
                                            'pm4_palas'  ,...
                                            'pm10_palas' ,...
                                            'pmTotal_palas',...
   ...
   %% Get Palas From Raw 
   display("Loading Raw From the Palas tab itself ")
   load(strcat(palasFromcleRaw,"/Palas_Edit_Dec17th2020.mat"))
   palasAirAll.longitude_palas = [];
   palasAirAll.latitude_palas = [];
   palasDataAll = table2timetable(palasAirAll);
   palasDataAll.Properties.VariableNames= {'pm1_palas',...
                                            'pm2_5_palas',...
                                            'pm4_palas'  ,...
                                            'pm10_palas' ,...
                                            'pmTotal_palas',...
